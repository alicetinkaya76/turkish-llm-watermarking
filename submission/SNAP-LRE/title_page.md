...
required, and is not acknowledged here, since no AI system is credited as a
contributor.
...
## Declarations (summary, with full statements in the manuscript)
...
- **Data, material and code availability.** Openly available at
  ...
  `v1.7.0-paper`), archived at Zenodo, concept DOI 10.5281/zenodo.22168552, which
