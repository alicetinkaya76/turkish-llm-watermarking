...
release tag `v1.8.0-paper`, which freezes the exact code, data and manuscript state
...
`v1.8.0-paper`. Nine earlier releases (10.5281/zenodo.22168553, 22212071, 22230948, 22231200,
22249519, 22255372, 22271924, 22273963 and 22275847) predate corrections described in Sections 3.3 and 4.2, the condensation, the
